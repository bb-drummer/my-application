...
"use strict";
    ...
    var MyApplication = {
        ...
        /**
         * Defines a [MyApplication] plugin, adding it to the `MyApplication` namespace 
         ...
         * Adds the `myappPlugin` data-attribute to programmatically created plugins 
         * to allow use of $(selector).myapplication(method) calls.
         * Also fires the initialization event for each plugin, consolidating repeditive code.
         * 
         * @param {Object} plugin - an instance of a plugin, usually `this` in context.
         * @param {String} name - the name of the plugin, passed as a camelCased string.
         * @fires Plugin#init balalal
         */
        ...
        GetYoDigits: function(length, namespace){
            ...
            ).toString(36).slice(1) + (namespace ? '-' + namespace : '');
        },
                ...
                $elem.each(function() {
                    ...
                    if ($el.data('myappPlugin')) {
                        console.warn("Tried to initialize "+name+" on an element that "+
                                "already has a [MyApplication] plugin.");
                        return;
                    }
    ...
    var myapplication = function(method) {
        ...
        if(type === 'undefined'){
            //needs to initialize the MyApplication object, or an individual plugin.
            ...
            var plugClass = this.data('myapp-plugin');
            ...
            throw new TypeError("We're sorry, '" + type + "' is not a valid parameter. "+
                "You must use a string representing the method you wish to invoke.");
        }
        return this;
    };
